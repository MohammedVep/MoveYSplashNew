...
function MainFeed({ onShareToMessages } = {}) {
    const { currentUser, allUsers, addPost, fetchComments, addComment, sharePost, toggleSavePost, deletePost, updatePost } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$userContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUser"])();
    ...
    const handleDeletePost = async (post)=>{
        if (!currentUser || currentUser.id !== post.userId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].info('You can only delete your own posts.');
            return;
        }
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Unable to delete post right now.');
            setPosts(previous);
        } finally{
    ...
    const handleStartEdit = (post)=>{
        if (!currentUser || currentUser.id !== post.userId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].info('You can only edit your own posts.');
            return;
        }
    ...
    const handleSaveEdit = async (post)=>{
        ...
        if (!trimmed) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].info('Add some text to your post.');
            return;
        }
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Post updated');
            setEditingPostId(null);
            setEditDraft('');
        } catch (error) {
            console.error('Error updating post:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Unable to update post right now.');
            setPosts(previous);
        } finally{
    ...
    const handleCopyLink = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((postId, authorId)=>{
        const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$shareUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildPostShareUrl"])(postId, authorId);
        if (typeof navigator !== 'undefined' && navigator.clipboard?.writeText) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].info(url, {
...
//# sourceMappingURL=src_app_components_MainFeed_tsx_6a8e06e8._.js.map