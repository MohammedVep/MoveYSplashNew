module.exports = [
"[project]/node_modules/ably/build/ably-node.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
Released under the Apache Licence v2.0*/ (function(g, f) {
    if ("TURBOPACK compile-time truthy", 1) {
        module.exports = f(__turbopack_context__.r("[project]/node_modules/ws/index.js [app-ssr] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/got/dist/source/index.js [app-ssr] (ecmascript)"));
    } else //TURBOPACK unreachable
    ;
})(/*TURBOPACK member replacement*/ __turbopack_context__.e, (__da, __db)=>{
    var exports = {};
    var module1 = {
        exports
    };
    ...
    var require_from = __commonJS({
        "node_modules/bops/from.js" (exports2, module2) {
            var Buffer2 = __turbopack_context__.r("[externals]/buffer [external] (buffer, cjs)").Buffer;
            ...
            Decoder.prototype.parse = function() {
                ...
                switch(type){
                    ...
                    case 212:
                        ...
                        this.offset += 3;
                        return extType === 0 && value === 0 ? void 0 : [
                            extType,
                            value
                        ];
                    case 213:
    ...
    var globalObject = ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable";
 ...
 */ _Logger.logAction = (logger, level, action, message)=>{
            ...
            if (resolvedAuthOptions.authCallback) {
                ...
                tokenRequestCallback = (params, cb)=>{
                    ...
                    const authUrlRequestCallback = (result)=>{
                        ...
                        if (result.error) {
                            logger_default.logAction(this.logger, logger_default.LOG_MICRO, "Auth.requestToken().tokenRequestCallback", "Received Error: " + inspectError(result.error));
                        } else {
   ...
   */ async getTimestamp(queryTime) {
    ...
    function logResult2(result, method, path, params, logger) {
        if (result.err) {
            logger_default.logAction(logger, logger_default.LOG_MICRO, "Resource." + method + "()", "Received Error; " + appendingParams(path, params) + "; Error: " + inspectError(result.err));
        } else {
            logger_default.logAction(logger, logger_default.LOG_MICRO, "Resource." + method + "()", "Received; " + appendingParams(path, params) + "; Headers: " + paramString(result.headers) + "; StatusCode: " + result.statusCode + "; Body: " + (Platform.BufferUtils.isBuffer(result.body) ? " (Base64): " + Platform.BufferUtils.base64Encode(result.body) : ": " + Platform.Config.inspect(result.body)));
        }
    }
   ...
   */ constructor(options){
    ...
    var RealtimeChannel = class _RealtimeChannel extends eventemitter_default {
        ...
        async publish(...args) {
            ...
            if (argCount == 1) {
                if (isObject(args[0])) {
                    messages = [
                        message_default.fromValues(args[0])
                    ];
        ...
        async processMessage(message) {
            ...
            switch(message.action){
                ...
                default:
                    logger_default.logAction(this.logger, logger_default.LOG_MAJOR, "RealtimeChannel.processMessage()", "Protocol error: unrecognised message action (" + message.action + ")");
            }
        }
    ...
    var MessageQueue = class extends eventemitter_default {
        ...
        completeMessages(serial, count, err) {
            logger_default.logAction(this.logger, logger_default.LOG_MICRO, "MessageQueue.completeMessages()", "serial = " + serial + "; count = " + count);
            err = err || null;
    ...
    var globalObject2 = ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable";
    var haveWebStorage = ()=>{
        var _a2;
        ...
        getTransportParams(callback) {
            ...
            decideMode((mode)=>{
                ...
                if (mode === "recover") {
                    ...
                    logger_default.logAction(this.logger, logger_default.LOG_MINOR, "ConnectionManager.getTransportParams()", "Transport params = " + transportParams.toString());
                }
   ...
   */ activateTransport(error, transport, connectionId, connectionDetails) {
            ...
            if (connectionId) {
                logger_default.logAction(this.logger, logger_default.LOG_MICRO, "ConnectionManager.activateTransport()", "connectionId =  " + connectionId);
            }
            if (connectionDetails) {
                logger_default.logAction(this.logger, logger_default.LOG_MICRO, "ConnectionManager.activateTransport()", "connectionDetails =  " + JSON.stringify(connectionDetails));
            }
   ...
   * being activated */ noTransportsScheduledForActivation() {
        ...
        setConnection(connectionId, connectionDetails, hasConnectionError) {
            ...
            if (this.connectionId !== connectionId) {
                logger_default.logAction(this.logger, logger_default.LOG_MINOR, "ConnectionManager.setConnection()", "New connectionId; reattaching any attached channels");
            }
                ...
                if (this.realtime.http.checkConnectivity) {
                    whenPromiseSettles(this.realtime.http.checkConnectivity(), (err, connectivity)=>{
                        if (err || !connectivity) {
                            ...
                            logger_default.logAction(this.logger, logger_default.LOG_MINOR, "ConnectionManager WebSocket slow timer", "http connectivity check succeeded");
                        }
                    });
                }
            ...
            this.webSocketGiveUpTimer = setTimeout(()=>{
                ...
                if (!this.wsCheckResult) {
                    ...
                    if (this.baseTransport) {
                        ...
                        logger_default.logAction(this.logger, logger_default.LOG_MAJOR, "ConnectionManager WebSocket give up timer", "websocket connectivity appears to be unavailable but no other transports to try");
                    }
                }
   ...
   ******************/ send(msg, queueEvent, callback) {
            ...
            if (this.logger.shouldLog(logger_default.LOG_MICRO)) {
                logger_default.logAction(this.logger, logger_default.LOG_MICRO, "ConnectionManager.send()", "queueing msg; " + stringify(msg, this.realtime._RealtimePresence, this.realtime._Annotations, this.realtime._objectsPlugin));
            }
        ...
        queue(msg, callback) {
            ...
            if (lastQueued && !lastQueued.sendAttempted && bundleWith(lastQueued.message, msg, maxSize)) {
                if (!lastQueued.merged) {
                    lastQueued.callback = multicaster_default.create(this.logger, [
                        lastQueued.callback
                    ]);
   ...
   * for historical reasons; the browser equivalents return ArrayBuffers */ isBuffer(buffer) {
    ...
    var import_crypto2 = __toESM(__turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)"));
    var import_util = __toESM(__turbopack_context__.r("[externals]/util [external] (util, cjs)"));
     ...
     */ static getCipher(params, logger) {
        ...
        class CBCCipher {
            ...
            async encrypt(plaintext) {
                ...
                var cipherOut = this.encryptCipher.update(Buffer.concat([
                    plaintextBuffer,
                    pkcs5Padding[paddedLength - plaintextLength]
                ]));
            ...
            async decrypt(ciphertext) {
                ...
                if (final && final.length) plaintext = Buffer.concat([
                    plaintext,
                    final
                ]);
                return plaintext;
    ...
    var import_got = __toESM(__turbopack_context__.r("[project]/node_modules/got/dist/source/index.js [app-ssr] (ecmascript)"));
    var import_http5 = __toESM(__turbopack_context__.r("[externals]/http [external] (http, cjs)"));
                ...
                switch(headers["content-type"]){
                    ...
                    case "application/x-msgpack":
                        if (!((_a2 = this.client) == null ? void 0 : _a2._MsgPack)) {
                            return {
                                error: createMissingPluginError("MsgPack")
                            };
                        }
                        body = this.client._MsgPack.decode(body);
                        break;
                }
                const error = body.error ? ErrorInfo.fromValues(body.error) : new ErrorInfo(headers["x-ably-errormessage"] || "Error response received from server: " + statusCode + " body was: " + Platform.Config.inspect(body), Number(headers["x-ably-errorcode"]), statusCode);
                return {
                    error,
                    body,
                    headers,
    ...
    var import_crypto3 = __toESM(__turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)"));
    var import_ws = __toESM(__turbopack_context__.r("[project]/node_modules/ws/index.js [app-ssr] (ecmascript)"));
    var import_util2 = __toESM(__turbopack_context__.r("[externals]/util [external] (util, cjs)"));
    var Config = {
     ...
     */ this.onAuthUpdated = (tokenDetails)=>{
        ...
        onData(responseData) {
            try {
                ...
                if (items && items.length) for(let i = 0; i < items.length; i++)this.onProtocolMessage(fromDeserialized(items[i], this.connectionManager.realtime._RealtimePresence, this.connectionManager.realtime._Annotations, this.connectionManager.realtime._objectsPlugin));
            } catch (e) {
    ...
    var import_http6 = __toESM(__turbopack_context__.r("[externals]/http [external] (http, cjs)"));
    var import_https2 = __toESM(__turbopack_context__.r("[externals]/https [external] (https, cjs)"));
    var import_url = __toESM(__turbopack_context__.r("[externals]/url [external] (url, cjs)"));
    var import_util3 = __toESM(__turbopack_context__.r("[externals]/util [external] (util, cjs)"));
    var noop3 = function() {};
    ...
    var NodeCometTransport = class extends comettransport_default {
        ...
        getAgent(tls) {
            ...
            if (!agent2) agent2 = this[prop] = new (tls ? import_https2.default : import_http6.default).Agent({
                keepAlive: true
            });
            return agent2;
        }
        ...
        /* valid in non-streaming mode only, or data only contains last update */ request(uri, params, body, requestMode, callback) {
        ...
        readFully() {
            ...
            res.on("end", function() {
                process.nextTick(function() {
                    ...
                    if (!err) {
                        err = new PartialErrorInfo("Error response received from server: " + statusCode + ", body was: " + import_util3.default.inspect(body), null, statusCode);
                    }
                    self2.complete(err);
                });
            });
   ...
   * intersection of baseTransportOrder and the transports clientOption that's supported. */ defaultTransports: [
            TransportNames.WebSocket
        ],
        restAgentOptions: {
            maxSockets: 40,
    ...
    if (typeof module1.exports == "object" && typeof exports == "object") {
        ...
        module1.exports = __cp(module1.exports, exports);
    }
...
//# sourceMappingURL=node_modules_ably_build_ably-node_3a7b4e03.js.map