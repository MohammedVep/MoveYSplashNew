...
"[project]/node_modules/ably/build/ably.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
Released under the Apache Licence v2.0*/ (function(g, f) {
    ...
    module1.exports = __toCommonJS(web_exports);
 ...
 */ _Logger.logAction = (logger, level, action, message)=>{
   ...
   * to utf8-decode a string to another string is almost certainly a mistake */ utf8Decode(buffer) {
        ...
        constructor(client){
            ...
            if (Platform.Config.xhrSupported && xhrRequestImplementation) {
                ...
                if (client == null ? void 0 : client.options.disableConnectivityCheck) {
                    ...
                    this.checkConnectivity = async function() {
                        var _a3;
                        logger_default.logAction(this.logger, logger_default.LOG_MICRO, "(XHRRequest)Http.checkConnectivity()", "Sending; " + connectivityCheckUrl);
                ...
                if (client == null ? void 0 : client.options.disableConnectivityCheck) {
                    ...
                    this.checkConnectivity = async function() {
                        var _a3;
                        logger_default.logAction(this.logger, logger_default.LOG_MICRO, "(Fetch)Http.checkConnectivity()", "Sending; " + connectivityCheckUrl);
    ...
    var globalObject3 = ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable";
...
//# sourceMappingURL=node_modules_ably_build_ably_c16df5b5.js.map