...
"[project]/src/app/utils/supabase/info.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/utils/userContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const sanitizeSettings = (settings)=>{
    ...
    if (sanitized.theme) {
        sanitized.theme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$settings$2d$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeThemePreference"])(sanitized.theme);
    }
...
function UserProvider({ children, initialUser = null, initialAllUsers }) {
    ...
    const [currentUser, setCurrentUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(normalizedInitialUser);
    const [allUsers, setAllUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialUsersMap);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProvider.useEffect": ()=>{
            ...
            ;
            const fetchUsers = {
                "UserProvider.useEffect.fetchUsers": async ()=>{
                    try {
                        ...
                        const payload = await response.json().catch({
                            "UserProvider.useEffect.fetchUsers": ()=>({})
                        }["UserProvider.useEffect.fetchUsers"]);
                        ...
                        setAllUsers({
                            "UserProvider.useEffect.fetchUsers": (prev)=>{
                                const updated = new Map(prev);
                                serverUsers.forEach({
                                    "UserProvider.useEffect.fetchUsers": (serverUser)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProvider.useEffect": ()=>{
            const preference = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$settings$2d$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeThemePreference"])(currentUser?.settings?.theme ?? defaultSettings.theme);
            const applyTheme = {
                "UserProvider.useEffect.applyTheme": ()=>{
    ...
    const calculateAchievements = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserProvider.useCallback[calculateAchievements]": (user)=>{
            ...
            const firstUsers = Array.from(allUsers.values()).sort({
                "UserProvider.useCallback[calculateAchievements].firstUsers": (a, b)=>(a.joinedAt instanceof Date ? a.joinedAt : new Date(a.joinedAt ?? new Date())).getTime() - (b.joinedAt instanceof Date ? b.joinedAt : new Date(b.joinedAt ?? new Date())).getTime()
            }["UserProvider.useCallback[calculateAchievements].firstUsers"]).slice(0, 100);
            if (firstUsers.some({
                "UserProvider.useCallback[calculateAchievements]": (u)=>u.id === user.id
            }["UserProvider.useCallback[calculateAchievements]"])) {
                achievements.push({
                    id: 'early-adopter',
                    name: 'Early Adopter',
            ...
            const postsWithMedia = safePosts.filter({
                "UserProvider.useCallback[calculateAchievements].postsWithMedia": (p)=>p.media && p.media.length > 0
            }["UserProvider.useCallback[calculateAchievements].postsWithMedia"]);
            ...
            const totalLikes = safePosts.reduce({
                "UserProvider.useCallback[calculateAchievements].totalLikes": (sum, post)=>sum + post.likes
            }["UserProvider.useCallback[calculateAchievements].totalLikes"], 0);
            if (totalLikes >= 1000) {
                achievements.push({
                    id: 'rising-star',
                    name: 'Rising Star',
            ...
            const totalComments = safePosts.reduce({
                "UserProvider.useCallback[calculateAchievements].totalComments": (sum, post)=>sum + post.comments
            }["UserProvider.useCallback[calculateAchievements].totalComments"], 0);
            ...
            if (safePosts.some({
                "UserProvider.useCallback[calculateAchievements]": (p)=>p.likes >= 500
            }["UserProvider.useCallback[calculateAchievements]"])) {
                achievements.push({
                    id: 'viral-creator',
                    name: 'Viral Creator',
                    description: 'Created a post with 500+ likes',
                    earnedAt: safePosts.find({
                        "UserProvider.useCallback[calculateAchievements]": (p)=>p.likes >= 500
                    }["UserProvider.useCallback[calculateAchievements]"])?.timestamp || now,
                    icon: 'Zap',
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProvider.useEffect": ()=>{
            ...
            const isSame = existing.length === achievements.length && existing.every({
                "UserProvider.useEffect": (achievement, index)=>achievement.id === achievements[index]?.id
            }["UserProvider.useEffect"]);
            if (isSame) {
                return;
            }
    ...
    const fetchUserSnapshot = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserProvider.useCallback[fetchUserSnapshot]": async (userId)=>{
            try {
                ...
                if (postsResponse.ok) {
                    ...
                    posts = savedPosts.map({
                        "UserProvider.useCallback[fetchUserSnapshot]": (savedPost)=>({
                                ...savedPost,
                                timestamp: new Date(savedPost.timestamp)
                            })
                    }["UserProvider.useCallback[fetchUserSnapshot]"]);
                }
                return {
                    ...userData,
                    ...
                    savedPostIds: Array.isArray(userData.savedPostIds) ? userData.savedPostIds.filter({
                        "UserProvider.useCallback[fetchUserSnapshot]": (value)=>typeof value === 'string'
                    }["UserProvider.useCallback[fetchUserSnapshot]"]) : [],
                    posts,
                    settings,
                    achievements: []
    ...
    const loadProfileUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserProvider.useCallback[loadProfileUser]": async (userId)=>{
            if (!userId) {
                if (currentUser) {
                    setProfileUserId(currentUser.id);
                    setProfileUser(currentUser);
            ...
            setAllUsers({
                "UserProvider.useCallback[loadProfileUser]": (prev)=>{
                    const next = new Map(prev);
            ...
            }["UserProvider.useCallback[loadProfileUser]"]);
            return true;
        }
    }["UserProvider.useCallback[loadProfileUser]"], [
        currentUser,
    ...
    const refreshAllUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserProvider.useCallback[refreshAllUsers]": async ()=>{
            try {
                const response = await fetch(`${API_BASE_URL}/users`, {
                    headers: {
                        'Authorization': `Bearer ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$supabase$2f$info$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["publicAnonKey"]}`
                ...
                const payload = await response.json().catch({
                    "UserProvider.useCallback[refreshAllUsers]": ()=>null
                }["UserProvider.useCallback[refreshAllUsers]"]);
                const rawUsers = Array.isArray(payload?.users) ? payload.users : [];
                setAllUsers({
                    "UserProvider.useCallback[refreshAllUsers]": (prev)=>{
                        const next = new Map();
                        rawUsers.forEach({
                            "UserProvider.useCallback[refreshAllUsers]": (rawUser)=>{
                        ...
                        prev.forEach({
                            "UserProvider.useCallback[refreshAllUsers]": (value, key)=>{
                                if (!next.has(key)) {
                                    next.set(key, value);
                                }
                            }
                ...
                setCurrentUser({
                    "UserProvider.useCallback[refreshAllUsers]": (prev)=>{
                        ...
                        const serverEntry = rawUsers.find({
                            "UserProvider.useCallback[refreshAllUsers].serverEntry": (candidate)=>{
                                return typeof candidate === 'object' && candidate !== null && candidate.id === prev.id;
                            }
                        }["UserProvider.useCallback[refreshAllUsers].serverEntry"]);
                        if (!serverEntry) {
                            return prev;
                        }
                        ...
                        const sameFriends = prevFriendsSorted.length === mergedFriendsSorted.length && prevFriendsSorted.every({
                            "UserProvider.useCallback[refreshAllUsers]": (value, index)=>value === mergedFriendsSorted[index]
                        }["UserProvider.useCallback[refreshAllUsers]"]);
                        ...
                        const sameBlocked = prevBlockedSorted.length === mergedBlockedSorted.length && prevBlockedSorted.every({
                            "UserProvider.useCallback[refreshAllUsers]": (value, index)=>value === mergedBlockedSorted[index]
                        }["UserProvider.useCallback[refreshAllUsers]"]);
...
_s1(UserProvider, "So/jsbX8a3zaFadQtlz+aX979Ug=", false, function() {
    return [
...
"[project]/src/app/utils/shareUtils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/utils/notifications.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$SignupPage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/SignupPage.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$MainFeed$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/MainFeed.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$VideoChat$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/VideoChat.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$FriendsList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/FriendsList.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Stories$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/Stories.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$HelpCenter$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/HelpCenter.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$PrivacyPolicy$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/PrivacyPolicy.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$TermsOfUse$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/TermsOfUse.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$AboutUs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/AboutUs.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$CookiePolicy$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/CookiePolicy.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$FeaturePages$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/FeaturePages.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$ui$2f$sonner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/ui/sonner.tsx [app-client] (ecmascript)");
...
function AppShell() {
    _s();
    const { login, signup, logout, currentUser, loadProfileUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$userContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])() || '/';
    const derivedFromPath = deriveStateFromPath(pathname);
    const [appState, setAppState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(derivedFromPath.state);
    const [currentView, setCurrentView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(derivedFromPath.view);
    ...
    const [currentFeature, setCurrentFeature] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(derivedFromPath.feature);
    const [pendingShareDraft, setPendingShareDraft] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [pendingMessageTarget, setPendingMessageTarget] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const appContainerClass = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$ui$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('min-h-screen relative overflow-hidden transition-colors duration-500', isLightTheme ? 'bg-gradient-to-br from-rose-100 via-purple-100 to-sky-100 text-slate-900' : 'bg-gradient-to-br from-purple-900 via-pink-800 to-orange-700 text-white');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppShell.useEffect": ()=>{
            ...
            setSelectedProfileId({
                "AppShell.useEffect": (prev)=>prev ? prev : currentUser.id
            }["AppShell.useEffect"]);
        }
    }["AppShell.useEffect"], [
        currentUser
        ...
        "AppShell.useEffect": ()=>{
            ...
            const run = {
                "AppShell.useEffect.run": async ()=>{
                    ...
                    setIsProfileLoading(false);
                    if (!success) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Unable to load that profile right now.');
                    }
                }
    ...
    const handleSignup = async (name, email, password, birthdate)=>{
        ...
        if (success) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Welcome to MoveYSplash, ${name}! 🚀`);
            setSelectedProfileId(null);
            setAppState('app');
            setCurrentView('feed');
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Email already in use');
        }
    };
    const handleLogout = ()=>{
        logout();
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('See you later! 👋');
        setSelectedProfileId(null);
    ...
    if (appState === 'help') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$HelpCenter$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HelpCenter"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$ui$2f$sonner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Toaster"], {
                    position: "top-center"
                }, void 0, false, {
                    fileName: "[project]/src/app/page.tsx",
                    lineNumber: 366,
    ...
    if (appState === 'privacy') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$PrivacyPolicy$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PrivacyPolicy"], {
                    onBack: ()=>setAppState('landing')
                }, void 0, false, {
                    fileName: "[project]/src/app/page.tsx",
                    lineNumber: 374,
    ...
    if (appState === 'terms') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$TermsOfUse$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TermsOfUse"], {
                    onBack: ()=>setAppState('landing')
                }, void 0, false, {
                    fileName: "[project]/src/app/page.tsx",
                    lineNumber: 383,
    ...
    if (appState === 'about') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$AboutUs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AboutUs"], {
                    onBack: ()=>setAppState('landing')
                }, void 0, false, {
                    fileName: "[project]/src/app/page.tsx",
                    lineNumber: 392,
    ...
    if (appState === 'cookies') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$CookiePolicy$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CookiePolicy"], {
                    onBack: ()=>setAppState('landing')
                }, void 0, false, {
                    fileName: "[project]/src/app/page.tsx",
                    lineNumber: 401,
    ...
    if (appState === 'feature' && currentFeature) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$FeaturePages$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FeaturePages"], {
    ...
    if (appState === 'landing') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$LandingPage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LandingPage"], {
                    onGetStarted: ()=>setAppState('signup'),
    ...
    if (appState === 'login') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$LoginPage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoginPage"], {
                    onLogin: handleLogin,
                    onBack: ()=>setAppState('landing'),
    ...
    if (appState === 'signup') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$SignupPage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SignupPage"], {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: backgroundBlobs.map((className, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: className
                    }, index, false, {
                        fileName: "[project]/src/app/page.tsx",
                        lineNumber: 470,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    currentView === 'feed' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-6",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Stories$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Stories"], {}, void 0, false, {
                                fileName: "[project]/src/app/page.tsx",
                                lineNumber: 486,
                                columnNumber: 13
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$MainFeed$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MainFeed"], {
                    ...
                    (currentView === 'video' || activeCall) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$VideoChat$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VideoChat"], {
                    ...
                    currentView === 'friends' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$FriendsList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FriendsList"], {
                    ...
                    currentView === 'settings' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Settings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Settings"], {
                    ...
                    currentView === 'profile' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Profile$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Profile"], {
                        onShareToMessages: handleShareToMessages,
...
_s(AppShell, "if48Vs1hf5rmpFm6bKfj249wQ3Q=", false, function() {
    return [
...
_c = AppShell;
function App() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$userContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserProvider"], {
...
//# sourceMappingURL=src_app_0419f71b._.js.map